        ...
        <div class="informacion">
          <?php
              ...
              try {
                  ...
                  $sql = "SELECT * FROM registros_alarmas";
                  $stmt = $pdo->prepare($sql);
                  $stmt->execute();
                  $alarmas = $stmt->fetchAll(PDO::FETCH_ASSOC);
                  echo "<h2>Alarmas</h2>";
                  echo "<table>";
                  echo "<tr><th>ID</th><th>Alarma</th><th>Fecha</th><th>Hora</th><th>Estado</th></tr>";
                  foreach ($alarmas as $alarma) {
                    echo "<tr><td>".$alarma['id']."</td><td>".$alarma['id_alarma']."</td><td>".$alarma['fecha']."</td><td>".$alarma['hora']."</td><td>".$alarma['estado']."</td></tr>";
                  }
                  echo "</table><br>";
